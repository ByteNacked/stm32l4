...
///Reader of field `RT36`
pub type RT36_R = crate::R<bool, RT35_A>;
///Write proxy for field `RT36`
pub struct RT36_W<'a> {
    w: &'a mut W,
}
impl<'a> RT36_W<'a> {
...
///Reader of field `RT37`
pub type RT37_R = crate::R<bool, RT35_A>;
///Write proxy for field `RT37`
pub struct RT37_W<'a> {
    w: &'a mut W,
}
impl<'a> RT37_W<'a> {
...
///Reader of field `RT38`
pub type RT38_R = crate::R<bool, RT35_A>;
///Write proxy for field `RT38`
pub struct RT38_W<'a> {
    w: &'a mut W,
}
impl<'a> RT38_W<'a> {
