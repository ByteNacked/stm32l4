///Reader of register FS_GOTGINT
pub type R = crate::R<u32, super::FS_GOTGINT>;
///Writer for register FS_GOTGINT
pub type W = crate::W<u32, super::FS_GOTGINT>;
///Register FS_GOTGINT `reset()`'s with value 0
impl crate::ResetValue for super::FS_GOTGINT {
    type Type = u32;
    #[inline(always)]
...
///Reader of field `SEDET`
pub type SEDET_R = crate::R<bool, bool>;
///Write proxy for field `SEDET`
...
///Reader of field `SRSSCHG`
pub type SRSSCHG_R = crate::R<bool, bool>;
///Write proxy for field `SRSSCHG`
...
///Reader of field `HNSSCHG`
pub type HNSSCHG_R = crate::R<bool, bool>;
///Write proxy for field `HNSSCHG`
...
///Reader of field `HNGDET`
pub type HNGDET_R = crate::R<bool, bool>;
///Write proxy for field `HNGDET`
...
///Reader of field `ADTOCHG`
pub type ADTOCHG_R = crate::R<bool, bool>;
///Write proxy for field `ADTOCHG`
...
///Reader of field `DBCDNE`
pub type DBCDNE_R = crate::R<bool, bool>;
///Write proxy for field `DBCDNE`
