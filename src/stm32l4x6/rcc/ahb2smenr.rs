...
///Reader of field `HASH1SMEN`
pub type HASH1SMEN_R = crate::R<bool, bool>;
///Write proxy for field `HASH1SMEN`
pub struct HASH1SMEN_W<'a> {
    w: &'a mut W,
}
impl<'a> HASH1SMEN_W<'a> {
    ///Sets the field bit
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn hash1smen(&self) -> HASH1SMEN_R {
        HASH1SMEN_R::new(((self.bits >> 17) & 0x01) != 0)
    }
}
impl W {
    ///Bit 18 - Random Number Generator clocks enable during Sleep and Stop modes
    ...
    ///Bit 17 - HASH clock enable during Sleep and Stop modes
    #[inline(always)]
    pub fn hash1smen(&mut self) -> HASH1SMEN_W {
        HASH1SMEN_W { w: self }
    }
}
