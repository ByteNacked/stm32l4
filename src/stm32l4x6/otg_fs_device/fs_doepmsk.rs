///Reader of register FS_DOEPMSK
pub type R = crate::R<u32, super::FS_DOEPMSK>;
///Writer for register FS_DOEPMSK
pub type W = crate::W<u32, super::FS_DOEPMSK>;
///Register FS_DOEPMSK `reset()`'s with value 0
impl crate::ResetValue for super::FS_DOEPMSK {
    type Type = u32;
    #[inline(always)]
...
///Reader of field `STUPM`
pub type STUPM_R = crate::R<bool, bool>;
///Write proxy for field `STUPM`
...
///Reader of field `OTEPDM`
pub type OTEPDM_R = crate::R<bool, bool>;
///Write proxy for field `OTEPDM`
