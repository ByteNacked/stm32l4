///Reader of register FS_DAINTMSK
pub type R = crate::R<u32, super::FS_DAINTMSK>;
///Writer for register FS_DAINTMSK
pub type W = crate::W<u32, super::FS_DAINTMSK>;
///Register FS_DAINTMSK `reset()`'s with value 0
impl crate::ResetValue for super::FS_DAINTMSK {
    type Type = u32;
    #[inline(always)]
