...
///Reader of field `TTCM`
pub type TTCM_R = crate::R<bool, bool>;
///Write proxy for field `TTCM`
pub struct TTCM_W<'a> {
    w: &'a mut W,
}
impl<'a> TTCM_W<'a> {
...
///Reader of field `ABOM`
pub type ABOM_R = crate::R<bool, bool>;
///Write proxy for field `ABOM`
pub struct ABOM_W<'a> {
    w: &'a mut W,
}
impl<'a> ABOM_W<'a> {
...
///Reader of field `AWUM`
pub type AWUM_R = crate::R<bool, bool>;
///Write proxy for field `AWUM`
pub struct AWUM_W<'a> {
    w: &'a mut W,
}
impl<'a> AWUM_W<'a> {
...
///Reader of field `NART`
pub type NART_R = crate::R<bool, bool>;
///Write proxy for field `NART`
pub struct NART_W<'a> {
    w: &'a mut W,
}
impl<'a> NART_W<'a> {
...
///Reader of field `RFLM`
pub type RFLM_R = crate::R<bool, bool>;
///Write proxy for field `RFLM`
pub struct RFLM_W<'a> {
    w: &'a mut W,
}
impl<'a> RFLM_W<'a> {
...
///Reader of field `TXFP`
pub type TXFP_R = crate::R<bool, bool>;
///Write proxy for field `TXFP`
pub struct TXFP_W<'a> {
    w: &'a mut W,
}
impl<'a> TXFP_W<'a> {
...
///Reader of field `INRQ`
pub type INRQ_R = crate::R<bool, bool>;
///Write proxy for field `INRQ`
pub struct INRQ_W<'a> {
    w: &'a mut W,
}
impl<'a> INRQ_W<'a> {
