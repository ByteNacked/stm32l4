...
pub type R = crate::R<u32, super::FS_HCCHAR7>;
///Writer for register FS_HCCHAR7
pub type W = crate::W<u32, super::FS_HCCHAR7>;
///Register FS_HCCHAR7 `reset()`'s with value 0
impl crate::ResetValue for super::FS_HCCHAR7 {
    type Type = u32;
    #[inline(always)]
