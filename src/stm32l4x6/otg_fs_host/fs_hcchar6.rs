///Reader of register FS_HCCHAR6
pub type R = crate::R<u32, super::FS_HCCHAR6>;
///Writer for register FS_HCCHAR6
pub type W = crate::W<u32, super::FS_HCCHAR6>;
///Register FS_HCCHAR6 `reset()`'s with value 0
impl crate::ResetValue for super::FS_HCCHAR6 {
    type Type = u32;
    #[inline(always)]
