///Reader of register FS_HCTSIZ3
pub type R = crate::R<u32, super::FS_HCTSIZ3>;
///Writer for register FS_HCTSIZ3
pub type W = crate::W<u32, super::FS_HCTSIZ3>;
///Register FS_HCTSIZ3 `reset()`'s with value 0
impl crate::ResetValue for super::FS_HCTSIZ3 {
    type Type = u32;
    #[inline(always)]
