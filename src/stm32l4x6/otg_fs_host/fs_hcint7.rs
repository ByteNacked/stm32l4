///Reader of register FS_HCINT7
pub type R = crate::R<u32, super::FS_HCINT7>;
///Writer for register FS_HCINT7
pub type W = crate::W<u32, super::FS_HCINT7>;
///Register FS_HCINT7 `reset()`'s with value 0
impl crate::ResetValue for super::FS_HCINT7 {
    type Type = u32;
    #[inline(always)]
