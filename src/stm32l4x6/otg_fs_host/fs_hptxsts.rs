///Reader of register FS_HPTXSTS
pub type R = crate::R<u32, super::FS_HPTXSTS>;
///Writer for register FS_HPTXSTS
...
///Reader of field `PTXFSAVL`
pub type PTXFSAVL_R = crate::R<u16, u16>;
///Write proxy for field `PTXFSAVL`
...
///Reader of field `PTXQSAV`
pub type PTXQSAV_R = crate::R<u8, u8>;
///Reader of field `PTXQTOP`
