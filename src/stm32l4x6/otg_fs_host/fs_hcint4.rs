///Reader of register FS_HCINT4
pub type R = crate::R<u32, super::FS_HCINT4>;
///Writer for register FS_HCINT4
pub type W = crate::W<u32, super::FS_HCINT4>;
///Register FS_HCINT4 `reset()`'s with value 0
impl crate::ResetValue for super::FS_HCINT4 {
    type Type = u32;
    #[inline(always)]
