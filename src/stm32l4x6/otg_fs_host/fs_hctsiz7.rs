///Reader of register FS_HCTSIZ7
pub type R = crate::R<u32, super::FS_HCTSIZ7>;
///Writer for register FS_HCTSIZ7
pub type W = crate::W<u32, super::FS_HCTSIZ7>;
///Register FS_HCTSIZ7 `reset()`'s with value 0
impl crate::ResetValue for super::FS_HCTSIZ7 {
    type Type = u32;
    #[inline(always)]
