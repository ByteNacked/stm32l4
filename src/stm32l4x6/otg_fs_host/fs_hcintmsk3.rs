///Reader of register FS_HCINTMSK3
pub type R = crate::R<u32, super::FS_HCINTMSK3>;
///Writer for register FS_HCINTMSK3
pub type W = crate::W<u32, super::FS_HCINTMSK3>;
///Register FS_HCINTMSK3 `reset()`'s with value 0
impl crate::ResetValue for super::FS_HCINTMSK3 {
    type Type = u32;
    #[inline(always)]
