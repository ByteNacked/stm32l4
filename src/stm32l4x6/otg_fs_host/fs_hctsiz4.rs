///Reader of register FS_HCTSIZ4
pub type R = crate::R<u32, super::FS_HCTSIZ4>;
///Writer for register FS_HCTSIZ4
pub type W = crate::W<u32, super::FS_HCTSIZ4>;
///Register FS_HCTSIZ4 `reset()`'s with value 0
impl crate::ResetValue for super::FS_HCTSIZ4 {
    type Type = u32;
    #[inline(always)]
