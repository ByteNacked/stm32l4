///Reader of register FS_HCCHAR3
pub type R = crate::R<u32, super::FS_HCCHAR3>;
///Writer for register FS_HCCHAR3
pub type W = crate::W<u32, super::FS_HCCHAR3>;
///Register FS_HCCHAR3 `reset()`'s with value 0
impl crate::ResetValue for super::FS_HCCHAR3 {
    type Type = u32;
    #[inline(always)]
...
///Reader of field `EPDIR`
pub type EPDIR_R = crate::R<bool, bool>;
///Write proxy for field `EPDIR`
...
///Reader of field `LSDEV`
pub type LSDEV_R = crate::R<bool, bool>;
///Write proxy for field `LSDEV`
...
///Reader of field `ODDFRM`
pub type ODDFRM_R = crate::R<bool, bool>;
///Write proxy for field `ODDFRM`
...
///Reader of field `CHDIS`
pub type CHDIS_R = crate::R<bool, bool>;
///Write proxy for field `CHDIS`
...
///Reader of field `CHENA`
pub type CHENA_R = crate::R<bool, bool>;
///Write proxy for field `CHENA`
