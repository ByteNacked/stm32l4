///Reader of register FS_HCCHAR2
pub type R = crate::R<u32, super::FS_HCCHAR2>;
///Writer for register FS_HCCHAR2
pub type W = crate::W<u32, super::FS_HCCHAR2>;
///Register FS_HCCHAR2 `reset()`'s with value 0
impl crate::ResetValue for super::FS_HCCHAR2 {
    type Type = u32;
    #[inline(always)]
