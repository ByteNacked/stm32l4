///Reader of register AWSCD6R
pub type R = crate::R<u32, super::AWSCD6R>;
///Writer for register AWSCD6R
pub type W = crate::W<u32, super::AWSCD6R>;
///Register AWSCD6R `reset()`'s with value 0
impl crate::ResetValue for super::AWSCD6R {
    type Type = u32;
    #[inline(always)]
