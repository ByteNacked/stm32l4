///Reader of register CHCFG7R1
pub type R = crate::R<u32, super::CHCFG7R1>;
///Writer for register CHCFG7R1
pub type W = crate::W<u32, super::CHCFG7R1>;
///Register CHCFG7R1 `reset()`'s with value 0
impl crate::ResetValue for super::CHCFG7R1 {
    type Type = u32;
    #[inline(always)]
