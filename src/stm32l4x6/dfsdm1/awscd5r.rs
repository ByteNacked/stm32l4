///Reader of register AWSCD5R
pub type R = crate::R<u32, super::AWSCD5R>;
///Writer for register AWSCD5R
pub type W = crate::W<u32, super::AWSCD5R>;
///Register AWSCD5R `reset()`'s with value 0
impl crate::ResetValue for super::AWSCD5R {
    type Type = u32;
    #[inline(always)]
