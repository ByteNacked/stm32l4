///Reader of register AWSCD3R
pub type R = crate::R<u32, super::AWSCD3R>;
///Writer for register AWSCD3R
pub type W = crate::W<u32, super::AWSCD3R>;
///Register AWSCD3R `reset()`'s with value 0
impl crate::ResetValue for super::AWSCD3R {
    type Type = u32;
    #[inline(always)]
