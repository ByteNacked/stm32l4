///Reader of register WCCR
pub type R = crate::R<u32, super::WCCR>;
///Writer for register WCCR
...
///Reader of field `IDTR`
pub type IDTR_R = crate::R<bool, bool>;
///Write proxy for field `IDTR`
pub struct IDTR_W<'a> {
    w: &'a mut W,
}
impl<'a> IDTR_W<'a> {
...
///Reader of field `ISIZE`
pub type ISIZE_R = crate::R<u8, u8>;
///Write proxy for field `ISIZE`
...
///Reader of field `ADDTR`
pub type ADDTR_R = crate::R<bool, bool>;
///Write proxy for field `ADDTR`
...
///Reader of field `ABDTR`
pub type ABDTR_R = crate::R<bool, bool>;
///Write proxy for field `ABDTR`
...
///Reader of field `DDTR`
pub type DDTR_R = crate::R<bool, bool>;
///Write proxy for field `DDTR`
pub struct DDTR_W<'a> {
    w: &'a mut W,
}
impl<'a> DDTR_W<'a> {
...
///Reader of field `DQSE`
pub type DQSE_R = crate::R<bool, bool>;
///Write proxy for field `DQSE`
pub struct DQSE_W<'a> {
    w: &'a mut W,
}
impl<'a> DQSE_W<'a> {
