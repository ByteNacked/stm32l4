...
///Reader of field `FT36`
pub type FT36_R = crate::R<bool, FT35_A>;
///Write proxy for field `FT36`
pub struct FT36_W<'a> {
    w: &'a mut W,
}
impl<'a> FT36_W<'a> {
...
///Reader of field `FT37`
pub type FT37_R = crate::R<bool, FT35_A>;
///Write proxy for field `FT37`
pub struct FT37_W<'a> {
    w: &'a mut W,
}
impl<'a> FT37_W<'a> {
...
///Reader of field `FT38`
pub type FT38_R = crate::R<bool, FT35_A>;
///Write proxy for field `FT38`
pub struct FT38_W<'a> {
    w: &'a mut W,
}
impl<'a> FT38_W<'a> {
