///Reader of register CH5DATINR
pub type R = crate::R<u32, super::CH5DATINR>;
///Writer for register CH5DATINR
pub type W = crate::W<u32, super::CH5DATINR>;
///Register CH5DATINR `reset()`'s with value 0
impl crate::ResetValue for super::CH5DATINR {
    type Type = u32;
    #[inline(always)]
