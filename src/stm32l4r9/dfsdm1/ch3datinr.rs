///Reader of register CH3DATINR
pub type R = crate::R<u32, super::CH3DATINR>;
///Writer for register CH3DATINR
pub type W = crate::W<u32, super::CH3DATINR>;
///Register CH3DATINR `reset()`'s with value 0
impl crate::ResetValue for super::CH3DATINR {
    type Type = u32;
    #[inline(always)]
