///Reader of register CH1CFGR2
pub type R = crate::R<u32, super::CH1CFGR2>;
///Writer for register CH1CFGR2
pub type W = crate::W<u32, super::CH1CFGR2>;
///Register CH1CFGR2 `reset()`'s with value 0
impl crate::ResetValue for super::CH1CFGR2 {
    type Type = u32;
    #[inline(always)]
