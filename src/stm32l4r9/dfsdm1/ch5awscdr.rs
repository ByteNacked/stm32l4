///Reader of register CH5AWSCDR
pub type R = crate::R<u32, super::CH5AWSCDR>;
///Writer for register CH5AWSCDR
pub type W = crate::W<u32, super::CH5AWSCDR>;
///Register CH5AWSCDR `reset()`'s with value 0
impl crate::ResetValue for super::CH5AWSCDR {
    type Type = u32;
    #[inline(always)]
