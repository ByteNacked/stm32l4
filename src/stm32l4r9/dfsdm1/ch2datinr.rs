///Reader of register CH2DATINR
pub type R = crate::R<u32, super::CH2DATINR>;
///Writer for register CH2DATINR
pub type W = crate::W<u32, super::CH2DATINR>;
///Register CH2DATINR `reset()`'s with value 0
impl crate::ResetValue for super::CH2DATINR {
    type Type = u32;
    #[inline(always)]
