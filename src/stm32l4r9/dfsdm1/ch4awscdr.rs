///Reader of register CH4AWSCDR
pub type R = crate::R<u32, super::CH4AWSCDR>;
///Writer for register CH4AWSCDR
pub type W = crate::W<u32, super::CH4AWSCDR>;
///Register CH4AWSCDR `reset()`'s with value 0
impl crate::ResetValue for super::CH4AWSCDR {
    type Type = u32;
    #[inline(always)]
