///Reader of register CH4DATINR
pub type R = crate::R<u32, super::CH4DATINR>;
///Writer for register CH4DATINR
pub type W = crate::W<u32, super::CH4DATINR>;
///Register CH4DATINR `reset()`'s with value 0
impl crate::ResetValue for super::CH4DATINR {
    type Type = u32;
    #[inline(always)]
