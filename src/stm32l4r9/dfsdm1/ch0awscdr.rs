///Reader of register CH0AWSCDR
pub type R = crate::R<u32, super::CH0AWSCDR>;
///Writer for register CH0AWSCDR
pub type W = crate::W<u32, super::CH0AWSCDR>;
///Register CH0AWSCDR `reset()`'s with value 0
impl crate::ResetValue for super::CH0AWSCDR {
    type Type = u32;
    #[inline(always)]
