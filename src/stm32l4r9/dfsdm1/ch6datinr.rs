///Reader of register CH6DATINR
pub type R = crate::R<u32, super::CH6DATINR>;
///Writer for register CH6DATINR
pub type W = crate::W<u32, super::CH6DATINR>;
///Register CH6DATINR `reset()`'s with value 0
impl crate::ResetValue for super::CH6DATINR {
    type Type = u32;
    #[inline(always)]
