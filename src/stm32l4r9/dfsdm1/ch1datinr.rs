///Reader of register CH1DATINR
pub type R = crate::R<u32, super::CH1DATINR>;
///Writer for register CH1DATINR
pub type W = crate::W<u32, super::CH1DATINR>;
///Register CH1DATINR `reset()`'s with value 0
impl crate::ResetValue for super::CH1DATINR {
    type Type = u32;
    #[inline(always)]
