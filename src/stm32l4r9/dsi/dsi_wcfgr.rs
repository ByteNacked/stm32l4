///Reader of register DSI_WCFGR
pub type R = crate::R<u32, super::DSI_WCFGR>;
///Writer for register DSI_WCFGR
...
///Reader of field `TEPOL`
pub type TEPOL_R = crate::R<bool, bool>;
///Write proxy for field `TEPOL`
...
///Reader of field `TESRC`
pub type TESRC_R = crate::R<bool, bool>;
///Write proxy for field `TESRC`
...
///Reader of field `COLMUX`
pub type COLMUX_R = crate::R<u8, u8>;
///Write proxy for field `COLMUX`
...
///Reader of field `DSIM`
pub type DSIM_R = crate::R<bool, bool>;
///Write proxy for field `DSIM`
pub struct DSIM_W<'a> {
    w: &'a mut W,
}
impl<'a> DSIM_W<'a> {
