///Reader of register DSI_WRPCR
pub type R = crate::R<u32, super::DSI_WRPCR>;
///Writer for register DSI_WRPCR
...
///Reader of field `REGEN`
pub type REGEN_R = crate::R<bool, bool>;
///Write proxy for field `REGEN`
...
///Reader of field `NDIV`
pub type NDIV_R = crate::R<u8, u8>;
///Write proxy for field `NDIV`
pub struct NDIV_W<'a> {
    w: &'a mut W,
}
impl<'a> NDIV_W<'a> {
...
///Reader of field `PLLEN`
pub type PLLEN_R = crate::R<bool, bool>;
///Write proxy for field `PLLEN`
