///Reader of register DSI_PUCR
pub type R = crate::R<u32, super::DSI_PUCR>;
///Writer for register DSI_PUCR
...
///Reader of field `URCL`
pub type URCL_R = crate::R<bool, bool>;
///Write proxy for field `URCL`
pub struct URCL_W<'a> {
    w: &'a mut W,
}
impl<'a> URCL_W<'a> {
...
///Reader of field `UECL`
pub type UECL_R = crate::R<bool, bool>;
///Write proxy for field `UECL`
pub struct UECL_W<'a> {
    w: &'a mut W,
}
impl<'a> UECL_W<'a> {
...
///Reader of field `URDL`
pub type URDL_R = crate::R<bool, bool>;
///Write proxy for field `URDL`
pub struct URDL_W<'a> {
    w: &'a mut W,
}
impl<'a> URDL_W<'a> {
...
///Reader of field `UEDL`
pub type UEDL_R = crate::R<bool, bool>;
///Write proxy for field `UEDL`
pub struct UEDL_W<'a> {
    w: &'a mut W,
}
impl<'a> UEDL_W<'a> {
