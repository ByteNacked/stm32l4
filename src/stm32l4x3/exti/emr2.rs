///Reader of register EMR2
pub type R = crate::R<u32, super::EMR2>;
///Writer for register EMR2
...
///Reader of field `MR33`
pub type MR33_R = crate::R<bool, MR32_A>;
///Write proxy for field `MR33`
pub struct MR33_W<'a> {
    w: &'a mut W,
}
impl<'a> MR33_W<'a> {
...
///Reader of field `MR34`
pub type MR34_R = crate::R<bool, MR32_A>;
///Write proxy for field `MR34`
pub struct MR34_W<'a> {
    w: &'a mut W,
}
impl<'a> MR34_W<'a> {
...
///Reader of field `MR35`
pub type MR35_R = crate::R<bool, MR32_A>;
///Write proxy for field `MR35`
pub struct MR35_W<'a> {
    w: &'a mut W,
}
impl<'a> MR35_W<'a> {
...
///Reader of field `MR36`
pub type MR36_R = crate::R<bool, MR32_A>;
///Write proxy for field `MR36`
pub struct MR36_W<'a> {
    w: &'a mut W,
}
impl<'a> MR36_W<'a> {
...
///Reader of field `MR37`
pub type MR37_R = crate::R<bool, MR32_A>;
///Write proxy for field `MR37`
pub struct MR37_W<'a> {
    w: &'a mut W,
}
impl<'a> MR37_W<'a> {
...
///Reader of field `MR38`
pub type MR38_R = crate::R<bool, MR32_A>;
///Write proxy for field `MR38`
pub struct MR38_W<'a> {
    w: &'a mut W,
}
impl<'a> MR38_W<'a> {
...
///Reader of field `MR39`
pub type MR39_R = crate::R<bool, MR32_A>;
///Write proxy for field `MR39`
pub struct MR39_W<'a> {
    w: &'a mut W,
}
impl<'a> MR39_W<'a> {
